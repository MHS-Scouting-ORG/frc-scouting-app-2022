...
class Form extends React.Component{
    ...
    getMatchTeams(){
        let matchKey = /*put this years event key here*//* "2022casd" *//* */api.getRegional()/* */ + "_" + this.state.matchType + this.state.number + "m" + this.state.matchNumber;
        const teams = async () => {
            await fetch('https://www.thebluealliance.com/api/v3/event/' + /* '2022casd' */ /**/ api.getRegional() /**/ + '/matches',{
                mode: 'cors',
                headers:{
        ...
        if(incompleteForm === true && override === false){
            ...
            api.put({
                body: {
                    ...
                    MatchId: /* insert event year key here /*/ /* "2022casd" *//* */ api.getRegional() /**/ + "_" + this.state.matchType + this.state.number + "m" + this.state.matchNumber,
